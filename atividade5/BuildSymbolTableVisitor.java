...
//		n.s.accept(this);
	...
	public Void visit(ClassDeclSimple n) {
		...
		if (!this.symbolTable.containsClass(n.i.s)) {
			...
			System.out.println("Classe " + n.i.s + " ja definida no escopo atual");
			System.exit(0);
		}
...
//		}
	...
	public Void visit(ClassDeclExtends n) {
		...
		if (!this.symbolTable.containsClass(n.i.s)) {
			if (this.symbolTable.containsClass(n.j.s)) {
				...
				System.out.println("Classe " + n.j.s + " nao definida no escopo atual");
				System.exit(0);
			}
		} else {
			System.out.println("Classe " + n.i.s + " ja definida no escopo atual");
...
//		}
	...
	public Void visit(VarDecl n) {
		...
		if (this.currMethod == null) {
			if (!this.currClass.containsVar(n.i.s)) {
				this.currClass.addVar(n.i.s, n.t);
			} else {
				System.out.println("Variavel " + n.i.s + " ja existente na classe " + this.currClass.getId());
				System.exit(0);
			}
		} else {
			if (!this.currMethod.containsVar(n.i.s)) {
				this.currMethod.addVar(n.i.s, n.t);
			} else {
				System.out.println("Variavel " + n.i.s + " ja existente no metodo " + this.currMethod.getId());
				System.exit(0);
			}
		}
...
//		n.i.accept(this);
	...
	public Void visit(MethodDecl n) {
		...
		if (!this.currClass.containsMethod(n.i.s)) {
			...
			System.out.println("Metodo " + n.i.s + " ja definido no escopo atual");
			System.exit(0);
		}
...
//		n.e.accept(this);
	...
	public Void visit(Formal n) {
		...
		if (!this.currMethod.containsParam(n.i.s)) {
			this.currMethod.addParam(n.i.s, n.t);
		} else {
			System.out.println("Parametro " + n.i.s + " ja existente no metodo " + this.currMethod.getId());
			System.exit(0);
		}
